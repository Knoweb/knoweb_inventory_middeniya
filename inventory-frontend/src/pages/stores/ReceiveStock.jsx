    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-black text-slate-800 tracking-tight">Stock Receiving & Adjustment</h1>
            <p className="text-sm text-slate-500 font-medium">Record new stock-ins, process returns, and segregate damaged goods</p>
          </div>
        </div>
        <button
